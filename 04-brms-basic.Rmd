...
```{r, results='hide', warning=FALSE, results="hide"}
...
```{r}
loo1 <- loo(fit, moment_match = TRUE)
...
So this suggests the model without the interaction is preferred, but the difference is not large.
