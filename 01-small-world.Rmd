...
ggplot(out, aes(x = p, ymax = posterior, ymin = 0, group = toss)) +
  geom_ribbon(alpha = 0.3, fill = "red") +
  geom_ribbon(aes(x = p, ymax = prior, ymin = 0), alpha = 0.3) +
...
In the last example we updated are posterior with each additional piece of data. Let's do our calculations in a way more consistent with how we would probably do this experiment. We'll calculate the posterior distribution including all the data at once along with our initial prior.
