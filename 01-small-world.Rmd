...
Or we can go even further than just calculating credible intervals. For example, we can calculate how much probability density is above 0.5. This tells us the probability that there is more than 50% water on the globe, (conditional on our model and data).
