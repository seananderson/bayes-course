...
So far, we have calculated ELPD on the data predicted from a model fit to all the data. But we know this is an overly optimistic perspective on predictive ability for new data. Instead, we can compute log LOO predictive densities.
