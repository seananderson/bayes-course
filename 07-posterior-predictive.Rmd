...
1. Does it look plausible that the model could have generated the observed data? 
2. If not, what is the issue, what might have caused it, and how you might you fix it? (You don't actually have to fix it for this exercise!)
